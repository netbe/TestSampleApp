...
workspace = "TestingSampleApp.xcworkspace"
scheme = "CommandLineTests"
...
cmd = "xcodebuild -workspace #{workspace} -scheme #{scheme} -sdk iphonesimulator TEST_AFTER_BUILD=YES ONLY_ACTIVE_ARCH=NO RUN_UNIT_TEST_WITH_IOS_SIM=YES RUN_TESTS=1 clean build"
